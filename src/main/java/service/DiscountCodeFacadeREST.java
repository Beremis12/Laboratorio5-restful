...
import com.udea.customer1.entity.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.customer1.entity.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.udea_customer1_war_1.0-SNAPSHOTPU")
